...
response = requests.get("https://opentdb.com/api.php",params=parametters)
response.raise_for_status()

question_data = response.json()['results']


# response2 = requests.get("https://opentdb.com/api.php",params=parametters)
# response2.raise_for_status()

# question_data2 = response2.json()


# print(question_data2)
